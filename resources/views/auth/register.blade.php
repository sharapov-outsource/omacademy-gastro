                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                <label for="driver_license"
                                       class="col-md-4 col-form-label text-md-end">{{ __('Серия и номер водительского удостоверения') }}</label>
                                <div class="col-md-6">
                                    <input id="driver_license" type="text"
                                           class="form-control @error('driver_license') is-invalid @enderror"
                                           name="driver_license" value="{{ old('driver_license') }}" required
